...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ url('public') }}/politap.png" rel="icon">
    ...
    <link href="{{ url('public/home') }}/lib/animate/animate.min.css" rel="stylesheet">
...
<body>
    ...
    <script src="{{ url('public/home') }}/lib/wow/wow.min.js"></script>
    <script src="{{ url('public/home') }}/lib/easing/easing.min.js"></script>
    <script src="{{ url('public/home') }}/lib/waypoints/waypoints.min.js"></script>
